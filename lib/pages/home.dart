    ...
    final carouselCards = <Widget>[
      _CarouselCard(
        ...
        asset: const AssetImage(
          'assets/studies/hacker.png',
          package: 'flutter_gallery_assets',
        ),
        assetColor: const Color(0xFF344955),
        assetDark: const AssetImage(
          'assets/studies/hacker_dark.gif',
          package: 'flutter_gallery_assets',
        ),
        assetDarkColor: const Color(0xFF1D2327),
        textColor: Color.fromARGB(255, 183, 0, 255),
        studyRoute: starter_app_routes.defaultRoute,
      ),
      _CarouselCard(
        demo: studyDemos['shrine'],
        asset: const AssetImage(
          'assets/studies/criminal.png',
          package: 'flutter_gallery_assets',
        ),
        assetColor: const Color(0xFFFEDBD0),
        assetDark: const AssetImage(
          'assets/studies/criminal_dark.gif',
          package: 'flutter_gallery_assets',
        ),
        assetDarkColor: Color.fromARGB(255, 0, 0, 0),
      ...
      _CarouselCard(
        ...
        asset: const AssetImage(
          'assets/studies/weyland.png',
          package: 'flutter_gallery_assets',
          
        ),
        assetColor: const Color(0xFFD1F2E6),
        assetDark: const AssetImage(
          'assets/studies/weyland_dark.gif',
          package: 'flutter_gallery_assets',
        ),
      ...
      _CarouselCard(
        ...
        textColor: Color.fromARGB(255, 255, 255, 255),
        asset: const AssetImage(
          'assets/studies/civilian.jpg',
          package: 'flutter_gallery_assets',
        ),
        assetColor: const Color(0xFFD1F2E6),
        assetDark: const AssetImage(
          'assets/studies/civilian_dark.gif',
          package: 'flutter_gallery_assets',
        ),
        assetDarkColor: const Color (0xFF253538),
