...
class DummyDataService {
  static List<AccountData> getAccountDataList(BuildContext context) {
    ...
    String AssetsText = "Assets";
    String EquityCapital = "Equity Capital";
    String DebtCapital = "Debt Capital";
    String PreferredStock = "Preferred Stock";
  ...
  static List<UserDetailData> getAccountDetailList(BuildContext context) {
    ...
    return <UserDetailData>[
      ...
      UserDetailData(
        ...
        value: usdWithSignFormat(context).format(2331.14),
      ),
      UserDetailData(
        title: localizations.rallyAccountDetailDataInterestYtd,
        value: usdWithSignFormat(context).format(901.45),
      ),
      UserDetailData(
        title: localizations.rallyAccountDetailDataInterestPaidLastYear,
        value: usdWithSignFormat(context).format(2317.12),
      ),
      UserDetailData(
  ...
  static List<BudgetData> getBudgetDataList(BuildContext context) {
    final localizations = GalleryLocalizations.of(context)!;
    String capitalDebt = "Capital Debt";
    String manufacturingCost = "Manufacturing Cost";
    String financeCosts = "Finance Costs";
    String materialCosts = "Material Costs";
  ...
  static List<AlertData> getAlerts(BuildContext context) {
    final localizations = GalleryLocalizations.of(context)!;
    String dummyData = 'URGENT: Tax declaration, do not allow last year to happen again!!';
    return <AlertData>[
      AlertData(
        message: dummyData,
        iconData: Icons.sort,
